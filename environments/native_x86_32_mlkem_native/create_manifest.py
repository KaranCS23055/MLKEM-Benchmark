...
def main(raw_dir: Path, timestamp: str) -> int:
    pattern = f"native_x86_32_mlkem_native_mlkem_*_{timestamp}.csv"
    ...
    manifest_path = metadata_dir / f"native_x86_32_mlkem_native_{timestamp}_manifest.json"
    sha256_path = metadata_dir / f"native_x86_32_mlkem_native_{timestamp}_SHA256SUMS.txt"
    ...
    manifest = {
        ...
        "os": sample.get("os"),
        "note": "32-bit x86 (i686) native benchmark run using gcc -m32 under WSL2 Ubuntu."
    }
