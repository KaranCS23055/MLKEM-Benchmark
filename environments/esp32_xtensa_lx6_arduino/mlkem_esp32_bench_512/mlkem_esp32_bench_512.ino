/*
 * ML-KEM-512 Benchmark for ESP32 (Arduino IDE / ESP-IDF)
 * ========================================================
 * Benchmarks ML-KEM-512 on ESP32 (Xtensa LX6 Dual-Core @ 240 MHz).
...
#define VARIANT_LABEL    "ML-KEM-512"
...
void benchmarkTask(void *pvParameters) {
  Serial.println("# ================================================");
  Serial.println("# ML-KEM-512 Benchmark — ESP32 Xtensa LX6");
