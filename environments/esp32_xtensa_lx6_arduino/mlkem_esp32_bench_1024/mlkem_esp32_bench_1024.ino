/*
 * ML-KEM-1024 Benchmark for ESP32 (Arduino IDE / ESP-IDF)
 * ========================================================
 * Benchmarks ML-KEM-1024 on ESP32 (Xtensa LX6 Dual-Core @ 240 MHz).
...
void benchmarkTask(void *pvParameters) {
  Serial.println("# ================================================");
  Serial.println("# ML-KEM-1024 Benchmark — ESP32 Xtensa LX6");
