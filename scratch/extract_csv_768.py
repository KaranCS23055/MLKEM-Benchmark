...
valid_lines = []
for l in raw_lines:
    if l.startswith('"c9d712db-') and l.endswith('""'):
        parts = l.split(',')
        if len(parts) >= 20 and "ML-KEM-768" in l:
            valid_lines.append(l)

print(f"Total valid complete CSV lines for ML-KEM-768: {len(valid_lines)}")
...
out_path = r'c:\Users\KARAN PRAJAPATI\OneDrive\Desktop\MLKEM-Benchmark\data\raw\esp32_xtensa_lx6_arduino_mlkem_768_20260916T110000Z.csv'
